...
![](/images/66df544f-cfde-4dec-84bb-208dc34461a7-image.png)
...
$$
C_1(X) = I(X < 35), \; C_2(X) = I(35 \leq X < 50),\; \dots,\; C_4(X) = I(X \geq 65)
$$

![](/images/764113a5-9d62-4c35-9a37-44353169b0c9-image.png)
...
![](/images/871f2ef8-c4ac-40fb-879b-3c27da4efbe2-image.png)
...
$$
b_1(x_i) = x_i, \ b_2(x_i) = x_i^2, \ b_3(x_i) = x_i^3, \  b_{k+1}(x_i) = (x_i - \xi_k)_+^3, \quad k = 1, \ldots, K
$$

![](/images/ab9bdca1-5f0f-4e07-817d-e15aa612eca8-image.png)
...
![](/images/0ff74efb-5f45-40b4-bc09-67e04aeaac96-image.png)
...
![](/images/998cbbc4-ddd1-4fc8-968f-85cf80e7331a-image.png)
...
![](/images/508e99e0-8408-47c1-8d36-3dc3ab0ac9ab-image.png)
...
![](/images/f3851251-423d-4626-b0af-8a3772ece231-image.png)
