...
![](/images/b9c2095c-68c5-466d-8798-d54f864666fe-image.png)

이를 해결하기 위해 하나의 **hidden layer**를 갖는 FNN 모델을 생각하자. 해당 hidden layer는 두 개의 **hidden unit**을 갖는다.

![](/images/d474b3dd-5c71-4b1c-98eb-bc207fd5e07f-image.png)
...
![](/images/d446814c-e660-403b-ac29-703d4e85674f-image.png)
...
![](/images/95539b52-ab19-43a1-8c20-21ab970fd6fe-image.png)
...
## Output Units
FFN 모델을 비롯한 deep learning 학습에는 적절한 loss function 설정이 필수적이다. 일반적으로는 cross-entropy $$J(\theta) = -\mathbb{E}_{x,y \sim \hat{p}_{\text{data}}} \log p_{\text{model}}(y\mid x)$$를 사용하며, loss function의 형태는 output unit을 어떻게 표현하는지에 따라 결정된다.
...
![](/images/ce53fae4-5f72-42b4-9665-a40011373edb-image.png)
...
![](/images/dd36a6ae-dbee-4b95-b516-c7bb20720c4d-image.png)
...
![](/images/b9cf5466-8dcd-4dcc-907f-4cfebe46c709-image.png)
...
![](/images/72fe6480-15d2-492a-9bfd-a4fe74497d4e-image.png)
