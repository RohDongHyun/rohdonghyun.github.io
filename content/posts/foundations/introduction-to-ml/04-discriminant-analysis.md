...
![](/images/10bd26c8-ba97-426a-beff-78667f2958d1-image.png)

아래는 $p=2$이고 $K=3$인 경우에 대한 LDA 예시 그림이다.

![](/images/dc565abd-423f-413d-9547-0d39e1fa940c-image.png)
...
### Naive Bayes
만약, 각 class에서 $X$들이 independent한 경우(condtional independence), 즉 $f_k(x) = \prod_{j=1}^p f_{jk}(x_j)$이면, **naive Bayes** classification model이 된다.
