...
* 참고: [Autoencoder](https://velog.io/@rdh7014/Autoencoder/)
...
![](/images/19363e7a-55d0-4536-aa5e-13f3378e97cc-image.png)
...
![](/images/bfbb9444-53de-4004-ab37-a6eb36319b07-image.png)
...
> 우리가 알지 못하는 분포를 근사시켜 임의의 값을 생성해내는 VAE는 [variational inference](https://velog.io/@rdh7014/Variational-Inference)에서 이름과 개념을 가져왔다.


### ELBO
Deep learning을 이용한 학습을 위해서는 differentiable loss function을 적절하게 설정하는 것이 필요하다. VAE는 이를 위해 **ELBO** 를 사용한다.

* 참고: [ELBO (variational inference)](https://velog.io/@rdh7014/Variational-Inference)
...
![](/images/8135ba4e-ad88-4a05-9214-9ac305a1aee2-image.png)

위 network를 연결하면 아래와 같으며, 해당 network의 최종 output $\hat{x}$이 우리가 생성해낸 image가 된다.

![](/images/d38371b6-38ed-4182-88e6-83d1cbd3d1f7-image.png)
...
![](/images/b0803812-dc5a-4846-9f99-6381d9e2f23d-image.png)
...
![](/images/78aaf1c8-a5a3-4d11-9410-a0e00fb98ca1-image.png)
