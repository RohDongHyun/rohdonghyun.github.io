---
title: 06. Optimization vs Learning
date: 2025-09-21
tags:
...
$$
\begin{aligned}
&\min_{\theta} \mathbb{E}_{(x,y) \sim \hat{p}_{\text{data}}} \mathcal{L}(y, f(x; \theta)) + \lambda \Omega(\theta) \\
...
이렇듯 overfitting이 발생하기 시작하는 시점에 train을 멈추는 전략을 **early stopping**이라고 한다.

![](/images/d54ece26-a2e0-4a19-b657-3f606171c5db-image.png)