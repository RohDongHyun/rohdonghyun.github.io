...
![](/images/e1d457d5-4f94-4a48-841e-d8e5d9168b69-image.png)
...
![](/images/7cacc974-1535-4ef7-ad42-ff9845b21fd9-image.png)
...
![](/images/1a20d4d3-fdd4-4830-8be8-25241f18139b-image.png)
...
> $\sum_{i=1}^k \lambda_i x_i$를 확률(합이 1)에서의 기댓값으로도 볼 수 있다: $f(\mathbb{E}[x])\le \mathbb{E}[f(x)]$.
