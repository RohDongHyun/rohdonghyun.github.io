...
$$
\nabla_\theta J(\theta) \approx \ \mathbb{E}*{\pi*\theta} [\nabla_\theta \log \pi_\theta(s, a) Q_w(s,a)]
$$
...
>
> $$
> \varepsilon = \mathbb{E}*{\pi*\theta} [(Q^{\pi_\theta}(s,a) - Q_w(s,a))^2]
> $$
>
...
> 이 compatible function approximation 조건은 일반적인 Neural Network Actor-Critic에서는 거의 정확히 만족되지 않는다.
...
$$
\begin{aligned}
\mathbb{E}*{\pi*\theta}\left[\delta^{\pi_\theta} \mid s, a\right] &= \mathbb{E}*{\pi*\theta}\left[r + \gamma V^{\pi_\theta}(s') \mid s, a\right] - V^{\pi_\theta}(s) 
